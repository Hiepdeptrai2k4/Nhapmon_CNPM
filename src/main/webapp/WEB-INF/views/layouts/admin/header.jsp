...
<div class="wrapper">
	...
	<div class="iq-sidebar">
		<div class="iq-sidebar-logo d-flex justify-content-between">
			<a href="admin-dashboard.html" class="header-logo"> <img
			...
			<nav class="iq-sidebar-menu">
				<ul id="iq-sidebar-toggle" class="iq-menu">
					<li><a href="admin-dashboard.html"><i
							class="las la-home iq-arrow-left"></i>Bảng Điều Khiển</a></li>
					<li><a href="admin-category.html"><i
							class="ri-record-circle-line"></i>Danh Mục Sách</a></li>
					<li><a href="admin-author.html"><i
							class="ri-record-circle-line"></i>Tác Giả</a></li>
					<li><a href="admin-books.html"><i
							class="ri-record-circle-line"></i>Sách</a></li>
					<li><a href="sign-in.html"><i
							class="ri-record-circle-line"></i>Đăng Xuất</a></li>
				</ul>
			</nav>
				...
				<div class="iq-card">
					<div class="iq-card-body">
						<div class="sidebarbottom-content">
							<button type="submit"
								class="btn w-100 btn-primary mt-4 view-more">NhasachTV</button>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="iq-search-bar">
					<form action="#" class="searchbox">
						<input type="text" class="text search-input"
							placeholder="Tìm kiếm sản phẩm..."> <a
							...
							<div class="iq-sub-dropdown">
								<div class="iq-card shadow-none m-0">
									<div class="iq-card-body p-0 ">
										<div class="bg-primary p-3">
											<h5 class="mb-0 text-white">
												Tin Nhắn<small class="badge  badge-light float-right pt-1">5</small>
											</h5>
										</div>
										<a href="#" class="iq-sub-card">
											<div class="media align-items-center">
						...
						<li class="line-height pt-3"><a href="#"
							...
							<div class="iq-sub-dropdown iq-user-dropdown">
								<div class="iq-card shadow-none m-0">
									<div class="iq-card-body p-0 ">
										<div class="bg-primary p-3">
											<h5 class="mb-0 text-white line-height">Xin Chào Ông
												Trần Thuận</h5>
										</div>
