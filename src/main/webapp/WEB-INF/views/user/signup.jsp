                    ...
                    <div class="row m-0">
                      <div class="col-sm-12 sign-in-page-data">
                          <div class="sign-in-from bg-primary rounded">
                              ...
                              <form:form action="signup" method="POST" modelAttribute="user" class="mt-4 form-text">  
                                  ...
                                  <div class="form-group">
                                      ...
                                      <form:input type="email" class="form-control mb-0" id="exampleInputEmail2" placeholder="Enter email" path="email" />  
                                  </div>
                                  <div class="form-group">
