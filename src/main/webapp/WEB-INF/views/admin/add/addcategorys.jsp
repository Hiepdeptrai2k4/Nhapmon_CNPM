            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  ...
                  <div class="navbar-breadcrumb">
                     ...
                     <p class="mb-0"><span class="text-primary">Xin chào </span>Chào mừng bạn trở lại hồ sơ của bạn</p>
                  </div>
                              ...
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    <div class="bg-primary p-3">
                                       <h5 class="mb-0 text-white">Tất cả tin nhắn<small class="badge  badge-light float-right pt-1">5</small></h5>
                                    </div>
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body ml-3">
                                             ...
                                             <small class="float-left font-size-12">12-02</small>
                                          </div>
                                       </div>
                                    </a>
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body ml-3">
                                             ...
                                             <small class="float-left font-size-12">20-02</small>
                                          </div>
                                       </div>
                                    </a>
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body ml-3">
                                             <h6 class="mb-0 ">Tại sao tôi không sử dụng được ?</h6>
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body ml-3">
                                             ...
                                             <small class="float-left font-size-12">12-01</small>
                                          </div>
                                       </div>
                                    </a>
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body ml-3">
                                             ...
                                             <small class="float-left font-size-12">5-01</small>
                                          </div>
                                       </div>
                                    </a>
                                 </div>
                           ...
                           <div class="iq-sub-dropdown">
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 toggle-cart-info">
                                    <div class="bg-primary p-3">
                                       <h5 class="mb-0 text-white">Tất cả giỏ hàng<small class="badge  badge-light float-right pt-1">4</small></h5>
                                    </div>
                                    <a href="#" class="iq-sub-card">
                                       <div class="media align-items-center">
                                          <div class="">
                                    ...
                                    <div class="d-flex align-items-center text-center p-3">
                                       <a class="btn btn-primary mr-2 iq-sign-btn" href="#" role="button">Xem giỏ hàng</a>
                                       <a class="btn btn-primary iq-sign-btn" href="#" role="button">Cửa hàng ngay</a>
                                    </div>
                                 </div>
                              </div>
                           </div>
                                 ...
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="account-setting.html" class="iq-sub-card iq-bg-primary-hover">
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body ml-3">
                                             ...
                                             <p class="mb-0 font-size-12">Quản lý các thông số tài khoản của bạn.</p>
                                          </div>
                                       </div>
                                    </a>
                                    <a href="privacy-setting.html" class="iq-sub-card iq-bg-primary-hover">
                                       <div class="media align-items-center">
                                          ...
                                          <div class="media-body ml-3">
                                             <h6 class="mb-0 ">Những thiết lập riêng tư</h6>
                                             <p class="mb-0 font-size-12">Kiểm soát các thông số quyền riêng tư của bạn.</p>
                                          </div>
                                       </div>
                                    </a>
                                    <div class="d-inline-block w-100 text-center p-3">
                                       <a class="bg-primary iq-sign-btn" href="sign-in.html" role="button">Đăng xuất<i class="ri-login-box-line ml-2"></i></a>
                                    </div>
                                 </div>
                              </div>
                           </div>
