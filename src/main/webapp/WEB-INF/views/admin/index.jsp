                        ...
                        <div class="iq-card-body">
                           <div class="d-flex align-items-center">
                              ...
                              <div class="text-left ml-3">                                 
                                 <h2 class="mb-0"><span class="counter">${ profile.size() }</span></h2>
                     ...
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-body">
                           <div class="d-flex align-items-center">
                              ...
                              <div class="text-left ml-3">                                 
                                 <h2 class="mb-0"><span class="counter">${ bigBook.size() }</span></h2>
                                 <h5 class="">Sách</h5>
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-body">
                           <div class="d-flex align-items-center">
                              ...
                              <div class="text-left ml-3">                                 
                                 <h2 class="mb-0"><span class="counter">${ cartItem.size() }</span></h2>
